...
FIXES:
1. ✅ Class name: CaptionGenerator (correct)
2. ✅ No overlapping events (clean word-by-word)
3. ✅ 80px margins (no text cutoff)
4. ✅ Full special character sanitization
5. ✅ Bottom-center alignment (2) forced
6. ✅ Auto-fallback timings
...
class CaptionGenerator:  # ✅ Class name fixed
