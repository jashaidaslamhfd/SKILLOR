...
class VideoAssembler:
    ...
    def _create_ass(self, word_timings: List[Dict], ass_path: str, font_size: int = 90, max_duration: float = None):
        c = CAPTION_CONFIG
        # FIX: Alignment 2 (bottom-center) instead of mid-screen, with a
        # MarginV pulled up clear of the YouTube Shorts subscribe-button
        # safe zone (config exposes SAFE_ZONE_BOTTOM for exactly this).
        alignment = 2
...
Style: White,{c.FONT_NAME},{font_size},{c.PRIMARY_COLOR},&H000000FF,{c.OUTLINE_COLOR},&H00000000,1,0,0,0,100,100,2,0,1,{c.OUTLINE_WIDTH},{c.SHADOW},{alignment},10,10,{margin_v},1
Style: Red,{c.FONT_NAME},{font_size},{c.SECONDARY_COLOR},&H00FFFFFF,{c.OUTLINE_COLOR},&H00000000,1,0,0,0,100,100,2,0,1,{c.OUTLINE_WIDTH},{c.SHADOW},{alignment},10,10,{margin_v},1
