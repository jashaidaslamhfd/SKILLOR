...
- Gender: All genders
- Location: USA (PRIMARY TARGET), UK, Canada, Australia, Global English
- Device: 85%+ Mobile
...
MODERN HOOK RULES (2026) — SWIPE RATE KILLER:

CRITICAL: 70% of viewers decide to stay or swipe in the FIRST 1.5 SECONDS.
The hook MUST deliver an irresistible pattern interrupt in the FIRST 3 WORDS.

OLD hooks = INSTANT SWIPE:
- "Did you know" → passive, boring
- "Scientists discovered" → too formal, sounds like homework
- "Shocking truth" → overused, nobody believes it anymore
- Questions → weaker than statements
- Slow build-ups → viewer already swiped before you get to the point

WHAT WORKS IN 2026 — SWIPE STOPPERS:
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
### HOOK (8-10 words, 2-3 seconds) — THE SWIPE DECISION MOMENT:
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
70% of viewers decide in 1.5 seconds. This is the MOST IMPORTANT part of the script.
...
FORBIDDEN hooks (these cause INSTANT swipe):
...
❌ Any question format (questions are weaker than statements)
...
✓ NEVER start with "The", "A", "An", "When", "If", "Have" — too slow
✓ Universal — any age, any gender should nod their head
✓ Statement NOT question — statements create certainty, questions create doubt
...
Without a direct ask, viewers watch and scroll — zero engagement.
...
- AMERICAN ENGLISH ONLY: Use "color" not "colour", "favor" not "favour", "organize" not "organise", "recognize" not "recognise", "behavior" not "behaviour", "program" not "programme", "center" not "centre", "fiber" not "fibre", "defense" not "defence". Target audience is USA.
...
- 3-5 hashtags: include #Shorts, plus 2-3 topic-relevant hashtags (vary them per video, never repeat the same set)
