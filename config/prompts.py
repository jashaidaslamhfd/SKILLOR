...
- Use power words: Shocking, Hidden, Secret, Mystery, Unexplained, Truth
...
2. SUSPENSE (6-10s): Build tension, "But here's what's really happening..."
3. STORY (10-42s):
   - Fast-paced facts about what's happening in the body/brain
   - One UNEXPECTED TWIST — a surprising discovery that recontextualizes the facts
   - Each point: Fact + Implication + Emotion
   - Use "Imagine...", "What if...", "Picture this..."
4. LOOP/CTR (42-45s): Loop back to the hook's exact question, then "Part 2 reveals more..." or "Comment if this surprised you"

Rules:
- Word count: 110-130 words (for 45s at 150 WPM)
- Sentence length: Short, punchy
- Use vivid, almost unsettling imagery instead of dry textbook phrasing
- End with open loop that ties back to the hook
- NO fluff, NO filler
