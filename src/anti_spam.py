...
_NICHE_STOPWORDS = {
    ...
    "in", "on", "for", "with", "at", "by", "from", "as", "why", "what",
    "how", "when", "does", "do", "did", "can", "could", "would", "will",
    "body", "brain", "glitch", "wired", "weird", "science", "explained",
    "actually", "really", "happens", "happen", "ever", "wondered", "know",
    "shorts", "video",
}
