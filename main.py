...
# FIX (retention 80%+): Curiosity-driven hook templates
# Replace passive openings like "You repeat actions..." with pattern-interrupt hooks
RETENTION_HOOKS = [
    "Did you know {topic}? Your brain remembers what your mind forgets...",
    "What if I told you {topic}? Scientists just discovered something shocking...",
    "Stop scrolling if you {topic}. This will change how you see yourself...",
    "Your brain is hiding something. {topic} and nobody talks about it...",
    "I bet you didn't know {topic}. But your brain does...",
    "This is why you {topic}. And it's not what you think...",
    "The real reason you {topic} will shock you...",
]

def generate_retention_hook(topic: str) -> str:
    """Generate a curiosity-driven hook for 80%+ retention.

    Rules:
    - Max 12 words for first 3 seconds (instant grab)
    - Must contain a question, shocking fact, or pattern interrupt
    - Never start with "You" or "We" (too passive)
    """
    import random
